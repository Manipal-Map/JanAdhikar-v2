...
import { Scale, ArrowRight, ArrowLeft, ShieldAlert, CheckCircle2, Globe, ExternalLink, AlertCircle } from 'lucide-react'
          ...
          <div>
            ...
            <div className="bg-white border border-[#b8c2cc] rounded-3xl p-8 shadow-sm space-y-6 text-left">
              ...
              <div className="flex items-center justify-between pt-4 border-t border-slate-100">
                <button onClick={() => setStage('GRIEVANCE_GATHERING')} className="btn-ghost text-sm cursor-pointer">
