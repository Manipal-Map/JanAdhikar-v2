...
class OutcomeEngine:
    def __init__(self):
        self.model = "openai/gpt-oss-120b"  # Available on this Groq account
    ...
    def process_chat_turn(self, route: str, schema: List[Dict[str, Any]], current_facts: Dict[str, Any], user_message: str) -> Dict[str, Any]:
        ...
        try:
            ...
            print(f"[ChatTurn Fallback] Error processing chat turn: {e}")
            # Try to recover if it was a BadRequest with failed_generation or return safe structured response
            return {
                "new_facts_extracted": {},
                "ai_response": "Thank you for the details. Could you specify any other relevant information like incident dates, or click 'Generate Legal Demand Pack' to proceed?",
                "is_complete": False
            }
