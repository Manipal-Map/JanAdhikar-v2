          ...
          <div>
            ...
            <div className="bg-white border border-[#b8c2cc] rounded-3xl p-8 shadow-sm space-y-6 text-left">
              ...
              <div className="flex items-center justify-between pt-4 border-t border-slate-100">
                <button onClick={() => { setStage('RTI_GATHERING'); router.push('/dashboard/rti'); }} className="btn-ghost text-sm cursor-pointer">
          ...
          <div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-between pt-2">
                ...
                <button onClick={() => { setStage('IDLE'); router.push('/'); }} className="btn-ghost text-sm border-slate-300 cursor-pointer">
                  Start New Case (Home)
                </button>
              </div>
            </div>
