            ...
            <form onSubmit={handleNextStep} className="space-y-6">
              <div className="p-4 bg-blue-50 border border-blue-200 rounded-2xl flex items-start gap-3 shadow-xs">
                ...
                <p className="text-xs text-blue-950 font-medium leading-relaxed">
                  <strong>AI Strategy Engine:</strong> We have automatically structured the technical legal clauses, target authority, and statutory timelines based on your problem. Review and edit any specifics before we draft the final document.
                </p>
              </div>
                    ...
                    {isRTI ? (
                      <>
                        <div>
                          ...
                          <p className="font-medium text-slate-800 whitespace-pre-wrap leading-relaxed mt-1">{localForm.specific_records}</p>
                        </div>
                      </>
                    ) : (
                      <>
                        <div>
                          ...
                          <p className="font-medium text-slate-800 leading-relaxed mt-1">{localForm.desired_relief}</p>
                        </div>
                      </>
                    )}
                  </div>
