...
(Complainant / Aggrieved Party)`
  ...
  return (
    <div 
      className="min-h-screen flex flex-col items-center justify-center p-4 py-12 bg-cover bg-center bg-no-repeat relative text-ashoka-navy font-sans tracking-tight"
        ...
        {subStep === 1 ? (
          <div className="space-y-6">
            <div>
              ...
              <p className="text-slate-600 text-sm sm:text-base leading-relaxed font-medium drop-shadow-sm">
            ...
            <div className="bg-white/95 backdrop-blur-sm border border-slate-300 rounded-3xl p-6 sm:p-8 shadow-xl space-y-6 text-left">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between gap-3 pt-6 border-t border-slate-200">
                ...
                <button
                  ...
                  className="btn-primary text-base py-3.5 px-8 cursor-pointer w-full sm:w-auto justify-center shadow-md bg-[#A32A02] hover:bg-[#138808] transition-colors text-white font-bold tracking-tight"
                >
          ...
          <div className="space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
              <div>
                ...
                <h1 className="text-3xl sm:text-4xl font-extrabold text-ashoka-navy mt-2 tracking-tight drop-shadow-md">
            ...
            <p className="text-slate-600 text-sm leading-relaxed text-left font-medium drop-shadow-sm">
            ...
            <div className="space-y-6 text-left">
              ...
              <div className="bg-slate-50 border border-slate-300 rounded-2xl p-5 text-left space-y-2 shadow-inner">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between gap-3 pt-2">
                ...
                <button
                  ...
                  className="btn-primary text-sm py-3 px-6 cursor-pointer w-full sm:w-auto justify-center bg-[#A32A02] hover:bg-[#138808] transition-colors text-white font-bold tracking-tight shadow-md"
                >
                  Start Another Case
                </button>
              </div>
