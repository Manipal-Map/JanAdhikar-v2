...
export default function AudioRecorder({
  ...
  if (isTranscribing) {
    return (
      <button
        disabled
        className="flex items-center gap-2 px-4 py-2 bg-slate-100 text-slate-500 rounded-full border border-slate-200 text-sm font-semibold cursor-not-allowed"
      >
    ...
    <button
      ...
      className={`flex items-center gap-2 px-4 py-2 rounded-full border text-sm font-semibold transition-all cursor-pointer ${
        isRecording
          ...
          : 'bg-[#FAF8F5] border-[#E2E8F0] text-slate-900 hover:bg-slate-100'
      }`}
